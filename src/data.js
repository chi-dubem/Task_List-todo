const STATUS_ON_DECK = { id: 1, name: "On Deck", color: "#a8d8f0" };
const STATUS_IN_PROGRESS = {
  id: 2,
  name: "In Progress",
  color: "#f9e070",
};
const STATUS_TESTING = { id: 3, name: "Testing", color: "#f36fa0" };
const STATUS_DEPLOYED = { id: 4, name: "Deployed", color: "#bee7a5" };
